...
# message = 'Hi everyone, what are you learning about in this module?'
...
#     print(f'The message to put in the shirt is {message}')
...
# make_album('Won', 'Best songs')
# make_album('David', 'Happy Memory')
# make_album('John', 'Lovely cats',5)


# **Advanced**:*Write a while loop that allows users to enter an album’s artist and title. 
# Once you have that information, call make_album() with the user’s input and print the dictionary that’s created. 
# Be sure to include a quit value in the while loop.*
# while True:
#     artist_answer = input(f'Artist name : \n')
#     # print(f'artist name is: {artist_answer}')
#     title_answer = input(f'Title : \n')
#     # print(f'title is: {title_answer}')
#     make_album(artist_answer, title_answer)
#     break
...
# magician_names = ['David Copperfield', 'Michael', 'Stacy']
def show_magicians(list):
    for person in list:
        print(f'Magician name is ====> {person}')
...
def accept_items(*items):
    ...
    print(f'Items in the list {item_list}')
    return item_list

accept_items(['chicken','tomato','garlic'])
