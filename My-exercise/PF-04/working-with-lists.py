...
pizzasList = ['Mozirila','Vegetable','spicy','another']
for pizza in pizzasList:
    print(pizzasList.index(pizza)+1)
    print(f"Pizza name {pizza}")
...
favPizzaList = ['Mozerella','chicken', 'pineapple']
for pizza in favPizzaList:
...
friend_pizzas = ['Mozerella','chicken', 'pineapple', 'cheese' ]
...
fiveSimpleFood = ('apple', 'orange','banana','grapes','mango')
for food in fiveSimpleFood:
    print(food)

# fiveSimpleFood.append('kiwi')

fiveSimpleFood =  ('mushroom', 'chicken','banana','grapes','mango')
for food in fiveSimpleFood:
    print(food)